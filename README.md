...
For using AIShield Watchtower, we need to clone AIShield Watchtower repo and install prerequisites 
---
### Prerequisites
Cloning Watchtower repo 

```git
git clone <ADD github public repo>
```
...
In the Playground version, you will be able to scan public Github repos and view vulnerability reports. 
